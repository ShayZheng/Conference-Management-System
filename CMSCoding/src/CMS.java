    ...
    public void openSystem() throws Exception {
        ...
        while (!option.equals("4")) {
            ...
            switch (option) {
                case "1":
                    register();
                    break;//register function trigger
                case "2":
                    login();
                    break;//login function trigger
                case "3":
        ...
        if (email.equals(admin.getAdminUsername())) { // To check the email belongs to a normal user or the Administrator.
            ...
            while (!option.equals("4")) {
                ...
                switch (option) {
                    case "1":
                        retrieveUser();
                        break; // Retrieve the user information
                    case "2":
                        retrieveConference();
                        break; // Retrieve the conference information
                    case "3":
                        retrievePaper();
                        break; // Retrieve the paper information
                }
            }
